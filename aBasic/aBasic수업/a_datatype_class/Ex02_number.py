"""
        숫자형 종류
            ...
            - 8진수   0o25 = 2*8^1 + 5*8^0 = 21
            - 16진수  0x25 = 2*16^1 + 5*16^0 = 37
...
print('실수 1 : {0}, 정수 1 : {1}'.format(y,z)) #명확한 표기법
print('실수 1 : {1}, 정수 1 : {0}'.format(y,z)) # y,z 순서 바껴서 들어감
print('실수 1 : {0:0.1f}, 정수 1 : {1}'.format(y,z)) # 소숫점 한자리만 표기됨
