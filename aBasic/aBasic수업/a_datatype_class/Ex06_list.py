...
print(a[3][0],a[3][1],a[3][2],a[-2],a[-1])
print(a[0],a[1],a[2][0],a[2][1],a[3][0],a[3][1],a[3][2],a[-2])
print(a[3][1],a[3][2])
'''print(a[1:4])
print(a[3:6])
print(a[0:5])
...
# (2) 깊은 복사
a=[4,5,8,1,2]
b=a[:]          # b 에 a의 요소를 삽입함 (인덱스상 처음부터 끝까지 생략되어 있는 상태, 즉 모든 요소)
print(a,b)
b[0]='A'
print(a,b)